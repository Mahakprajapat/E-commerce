...
//     }, 
//   ]
//   json server dummy api ke liye use hota hai 
  ...
  return (
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
             ...
             <DesktopFilter handleFilter={handleFilter} filters={filters} ></DesktopFilter>
              ...
              <div>
              <Link to='/admin/productform' className='rounded-md mx-10 my-5 bg-black hover:text-indigo-500 px-3 py-2 text-sm font-semibold text-white'>
                Add Products
              </Link>
              </div>
          ...
          {/* secrion of product and filter end  */}
        ...
        <div>
          <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            ...
            {Array.from({length: totalPages }).map((el,index)=>(
                <div
                onClick={(e)=>handlePage(page<totalPages )}
                aria-current="page"
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          {products.map((product) => (
            ...
            <div key={product.id} className="group relative border-solid border-2 border-black-300 p-2  ">
            ...
            <div className='mt-5'>
              <Link to={`/admin/productform/edit/${product.id}`}
               className='rounded-md my-5 bg-indigo-600 hover:text-black px-3 py-2 text-sm font-semibold text-white'>
                Edit Product
              </Link>
              </div>
            </div>
